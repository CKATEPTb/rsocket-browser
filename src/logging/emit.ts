 ...
 */
import { FrameType, type Frame } from "rsocket-frames-ts";
import type { RSocketFrameActivity } from "@/types/index.js";
import type { RSocketConnectionEvent } from "@/reconnect/index.js";
import type {
 ...
 */
export function lifecycleLogEvent(event: RSocketConnectionEvent): Omit<RSocketLifecycleLogEvent, "category"> {
  ...
  if ("delayMs" in event) logEvent.delayMs = event.delayMs;
  return logEvent;
}
